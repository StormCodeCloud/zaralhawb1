<template>
  ...
  <section class="hero d-flex align-items-center justify-content-center"
    :style="{ backgroundImage: `url(${DzBG})` }">
    <div class="overlay"></div>
    <div class="hero-content text-center">
      <h1 class="hero-title">Loja Zaralha DayZ</h1>
      <p class="hero-subtitle">
        Itens exclusivos, kits VIP e recursos para os seus servidores DayZ
      </p>
    </div>
  </section>
...
import DzBG from '../assets/shop/shopDayZbg.jpg'
